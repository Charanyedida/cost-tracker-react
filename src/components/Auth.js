...
export default function Auth({ onLogin }) {
    ...
    useEffect(() => {
        // Switch animation between login/signup
        gsap.fromTo(formRef.current,
            { opacity: 0, x: -10 },
    ...
    return (
        <div className="auth-container" ref={containerRef}>
            <div className="auth-card glass-panel">
                <div className="auth-logo">CT</div>
                <div className="auth-header">
                    <p className="eyebrow">Cost clarity</p>
                    <h1>Project Cost Tracker</h1>
                    <p className="subtitle">{isLogin ? 'Sign in to keep every expense synced in the cloud.' : 'Create your workspace and start organising costs effortlessly.'}</p>
                </div>
                ...
                <div className="auth-footer">
                    ...
                    <p className="auth-note">Secured with Firebase Authentication</p>
                </div>
            </div>
        </div>
    );
